...
# === Configuration ===
input_csv = "../Harmonised_Data.csv"     # File that contains all data sources (reproducibility reviews)
output_csv = "stratified_sample.csv"     # File to store the random stratified sample
